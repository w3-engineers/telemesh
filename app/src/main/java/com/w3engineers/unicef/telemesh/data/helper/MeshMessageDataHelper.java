...
public class MeshMessageDataHelper {
    private static MeshMessageDataHelper meshMessageDataHelper = new MeshMessageDataHelper();
    protected CompositeDisposable compositeDisposable = new CompositeDisposable();
    //  private static MeshMessageDataHelper meshMessageDataHelper;

    public static MeshMessageDataHelper getInstance() {
/*        if (meshMessageDataHelper == null) {
            meshMessageDataHelper = new MeshMessageDataHelper();
            return meshMessageDataHelper;
        }*/
        return meshMessageDataHelper;
    }
