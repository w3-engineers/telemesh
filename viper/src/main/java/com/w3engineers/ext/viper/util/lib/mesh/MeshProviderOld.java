...
// Remove RM-Lib
public class MeshProviderOld /*implements MeshStateListener*/ {
    protected final int DEFAULT_ACK_ID = -1;
    private static final MeshProviderOld ourInstance = new MeshProviderOld();

    public static MeshProviderOld getInstance() {
        return ourInstance;
    }
